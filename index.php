...
<head>
    <meta charset="UTF-8">
    <title>Petter Harsem - pharsem.net</title>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-5" id="welcome">
                <h1>Welcome!</h1>
                <p>
                    Hi, my name is Petter, and I'm a web developer from Norway. I design and build beautiful websites
